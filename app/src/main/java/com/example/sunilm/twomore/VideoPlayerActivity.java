...
public class VideoPlayerActivity  extends AppCompatActivity {
 ...
 /*       String resourceString = "R.raw.";
        if(getIntent().getExtras() !=null) {
            VideoClass currentVideo = getIntent().getExtras().getParcelable("currentVideo");
            if (currentVideo != null) {
               // MEDIA_RES_ID = resourceString.concat(currentVideo.name);

                );
              getResources().getMovie(R.array.planets_array)
            } else {
